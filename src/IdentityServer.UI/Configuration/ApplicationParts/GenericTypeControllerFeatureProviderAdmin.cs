...
namespace IdentityServer.UI.Configuration.ApplicationParts
{
    public class GenericTypeControllerFeatureProviderAdmin<TUserDto, TUserDtoKey, TRoleDto, TRoleDtoKey, TUserKey, TRoleKey, TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TRoleClaim, TUserToken,
        ...
        where TRoleClaimsDto : RoleClaimsDto<TRoleDtoKey>
    {
        ...
        {
            var currentAssembly = typeof(GenericTypeControllerFeatureProviderAdmin<TUserDto, TUserDtoKey, TRoleDto, TRoleDtoKey, TUserKey, TRoleKey, TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TRoleClaim, TUserToken,
                TUsersDto, TRolesDto, TUserRolesDto, TUserClaimsDto,
